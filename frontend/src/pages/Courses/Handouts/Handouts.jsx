...
export const HandoutPdf = () => {
    return (
           <div className="px-[20px] py-[20px] my-[30px] flex flex-col gap-[40px] relative">
              <h1 className="text-[24] font-[600] text-center uppercase ">Handouts</h1>
              
               <button className="text-[16px] absolute top-3 right-[25px] font-[600] text-[#FA4F06] px-[12px] border rounded-[8px] py-[8px] ">Upload Handouts</button>
